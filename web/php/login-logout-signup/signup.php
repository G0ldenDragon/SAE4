...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO user (name, firstname, email, numtel, birthdate, adresse, password, competition, niveau, membre, admin, profile_picture, medical_certificate) VALUES (:name, :firstname, :email, :numtel, :birthdate, :adresse, :password, :competition, :niveau, :membre, :admin, :profile_picture, :medical_certificate)";
